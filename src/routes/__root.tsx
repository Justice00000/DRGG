  ...
  head: () => ({
    meta: [
      ...
      { title: "God'sgift Chukwuonye — Ph.D. Environmental Scientist" },
      {
        name: "description",
        content:
          "Ph.D. Environmental Scientist specializing in exposure science, environmental justice, and cumulative risk assessment in vulnerable communities.",
      },
      { name: "author", content: "God'sgift Chukwuonye" },
